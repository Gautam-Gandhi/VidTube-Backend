...
const updateAvatar = asyncHandler(async (req, res) => {
    ...
    // TODO: Delete old avatar from Cloudinary if it exists
...
const updateCoverImage = asyncHandler(async (req, res) => {
    ...
    // TODO: Delete old cover image from Cloudinary if it exists
...
export { registerUser, loginUser, refreshAccessToken, logoutUser, changeCurrentPassword, getCurrentUser, updateAccountDetails, updateAvatar, updateCoverImage };